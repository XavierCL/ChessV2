...
{
public:
	KillMove(const unsigned long long& origin, const unsigned long long& destination, const PieceType& pieceType)
		: _origin(origin),
	...
	{
		return board.bitBoards().arePiecesAt(_destination, !board.isWhiteTurn());
	}
